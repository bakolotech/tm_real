                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="libelle" name="libelle" placeholder="Ex: Univers beauté" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" name="ranger" id="ranger">
                                        <option value="1">Sur la ligne du haut</option>
                                        <option value="2">Sur la ligne du bas</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="background">Image de l'arrière plan des étagères</label>
