   <!-- debut pays exclus  -->
   <div class="hide"  id="dtServiceExpe" style="background-color: #fff; border-radius:5px 5px">
    <div>
            ...
            <button style="z-index: 1;
                                        ...
                                        height: 34px;
                                        width: 34px" type="button" id="closeNowOk2">
      ...
      "> <p style="color: #000000;
        ...
        line-height: 14px;text-align:center;margin-top:8px;">Sélectionnez les zones géographiques / les pays vers lesquels vous n'envoyez pas d'articles</p>
        </aside>
        <style>
            .pays_list_container {
                height: 193px;
        ...
        <div id="checkboxes" class="pays_list_container country_to_expulse" style="">
            ...
            <div class="pays_exclu_left">
                <div>
                    <label style="margin: 0px; padding: 0px; line-height: 20px">
                        <input style="width: 18px; height: 18px; margin: 0px; margin-right: 10px" class="form-check-input"  type="checkbox" id="pays1" value="Afrique" data-check = "1">Afrique <a href="#" onclick="montrePays(1)">(pays)</a>
                    </label>
                </div>
                {{-- ---------------------------------- pays africains --}}
                <div class="pays-continent s-none" style="width: 190px; height: auto; padding-top: 10px; padding-left: 15px" id="continentPays1">
                ...
                <div style="margin-top: 10px">
                    <label style="margin: 0px; padding: 0px; line-height: 20px">
                        <input style="width: 18px; height: 18px; margin: 0px; margin-right: 10px" class="form-check-input"  type="checkbox" id="pays2" value="Asie" data-check = "2">Asie <a href="#" onclick="montrePays(2)">(pays)</a>
                    </label>
                </div>
                {{-- ---------------------------------- pays asiatique--}}
                <div class="pays-continent s-none" style="width: 190px; height: auto; padding-top: 10px; padding-left: 15px" id="continentPays2">
                    <div>
                        <label style="margin: 0px; padding: 0px; line-height: 20px">
                ...
                <div style="margin-top: 10px">
                    <label style="margin: 0px; padding: 0px; line-height: 20px">
                        <input style="width: 18px; height: 18px; margin: 0px; margin-right: 10px" class="form-check-input"  type="checkbox" id="pays3" value="Moyen-Orient" data-check = "3">Moyen-Orient <a href="#" onclick="montrePays(3)">(pays)</a>
                    </label>
                </div>
                {{-- ---------------------------------- pays moyen orient --}}
                <div class="pays-continent s-none" style="width: 190px; height: auto; padding-top: 10px; padding-left: 15px" id="continentPays3">
                    <div>
                        <label style="margin: 0px; padding: 0px; line-height: 20px">
                ...
                <div style="margin-top: 10px">
                    <label style="margin: 0px; padding: 0px; line-height: 20px">
                        <input style="width: 18px; height: 18px; margin: 0px; margin-right: 10px" class="form-check-input"  type="checkbox" id="pays4" value="Amérique Centrale et Caraïbes" data-check = "4">Amérique Centrale et Caraïbes  <a href="#" onclick="montrePays(4)">(pays)</a>
                    </label>
                </div>
                 {{-- ---------------------------------- pays amerique central --}}
                 <div class="pays-continent s-none" style="width: 190px; height: auto; padding-top: 10px; padding-left: 15px" id="continentPays4">
                    <div>
                        <label style="margin: 0px; padding: 0px; line-height: 20px">
                ...
                <div style="margin-top: 10px">
                    <label style="margin: 0px; padding: 0px; line-height: 20px">
                        <input style="width: 18px; height: 18px; margin: 0px; margin-right: 10px" class="form-check-input"  type="checkbox" id="pays5" value="Amérique du sud" data-check = "5">Amérique du Sud <a href="#" onclick="montrePays(5)">(pays)</a>
                    </label>
                </div>
                {{-- ---------------------------------- pays amerique du sud --}}
                <div class="pays-continent s-none" style="width: 190px; height: auto; padding-top: 10px; padding-left: 15px" id="continentPays5">
                    <div>
                        <label style="margin: 0px; padding: 0px; line-height: 20px">
            ...
            <div class="pays_exclu_right">
                <div>
                    <label style="margin: 0px; padding: 0px; line-height: 20px">
                        <input style="width: 18px; height: 18px; margin: 0px; margin-right: 10px" class="form-check-input"  type="checkbox" id="pays6" value="Europe" data-check = "6">Europe  <a href="#" onclick="montrePays(6)">(pays)</a>
                    </label>
                </div>
                  {{-- ---------------------------------- pays europe --}}
                <div class="pays-continent s-none" style="width: 190px; height: auto; padding-top: 10px; padding-left: 15px" id="continentPays6">
                    <div>
                        <label style="margin: 0px; padding: 0px; line-height: 20px">
                ...
                <div style="margin-top: 10px">
                    <label style="margin: 0px; padding: 0px; line-height: 20px">
                        <input style="width: 18px; height: 18px; margin: 0px; margin-right: 10px" class="form-check-input"  type="checkbox" id="pays7" value="Océanie" data-check = "7">Océanie  <a href="#" onclick="montrePays(7)">(pays)</a>
                    </label>
                </div>
                  {{-- ---------------------------------- pays océanie --}}
                  <div class="pays-continent s-none" style="width: 190px; height: auto; padding-top: 10px; padding-left: 15px" id="continentPays7">
                    <div>
                        <label style="margin: 0px; padding: 0px; line-height: 20px">
                ...
                <div style="margin-top: 10px">
                    <label style="margin: 0px; padding: 0px; line-height: 20px">
                        <input style="width: 18px; height: 18px; margin: 0px; margin-right: 10px" class="form-check-input"  type="checkbox" id="pays8" value="Asie du Sud-Est" data-check = "8">Asie du Sud-Est <a href="#" onclick="montrePays(8)">(pays)</a>
                    </label>
                </div>
                  {{-- ---------------------------------- pays asie sud est --}}
                  <div class="pays-continent s-none" style="width: 190px; height: auto; padding-top: 10px; padding-left: 15px" id="continentPays8">
                    <div>
                        <label style="margin: 0px; padding: 0px; line-height: 20px">
                ...
                <div style="margin-top: 10px">
                    <label style="margin: 0px; padding: 0px; line-height: 20px">
                        <input style="width: 18px; height: 18px; margin: 0px; margin-right: 10px" class="form-check-input"  type="checkbox" id="pays9" value="Amérique du Nord" data-check = "9">Amérique du Nord  <a href="#" onclick="montrePays(9)">(pays)</a>
                    </label>
                </div>
                {{-- ---------------------------------- pays amerique du nord --}}
                <div class="pays-continent s-none" style="width: 190px; height: auto; padding-top: 10px; padding-left: 15px" id="continentPays9">
                    <div>
                        <label style="margin: 0px; padding: 0px; line-height: 20px">
        ...
        <div style="height: 65px !important;">
            <section id="aucun-lieu-bis" style=" height: 31px;
                    width: 553px;
                    ...
                    <section class="s-none" id="selected-lieux-section-bis"  style="height: auto; overflow-y:auto;
                    ...
                    text-align:left;margin-left:10px;"> Lieux exclus :
                        ...
                        letter-spacing: 0.26px;
                        line-height: 14px;
                    text-align:left;margin-top:-30px;margin-left:90px;" id="pays-exclu-preview-bis"> </p>
              ...
              <div style="display: flex; column-gap: 10px; position: relative; float: left; left: 247px !important; !important; margin-bottom: 15px">
                ...
                font-weight: 500;
                letter-spacing: 0.31px;
                line-height: 16px;" id="savePaysExclu1" onclick="sauveExpulsedCountry()" disabled> Enregistrer & fermer </button>
        ...
        <script>
            function montrePays(idcontinent) {
                // $('#continentPays1').removeClass('s-none')
                // console.log('Bonjour ok ok')
                if ($("#continentPays"+idcontinent).hasClass("s-none")) {
                    // console.log('Yes here i m', idContinent)
                    $("#continentPays"+idcontinent).removeClass('s-none')
                }else{
                    // $('#continent'+idContinent).addClass('s-none')
                    console.log('Ici ya autre chose')
                    $("#continentPays"+idcontinent).addClass('s-none')
                }
            }
        </script>
