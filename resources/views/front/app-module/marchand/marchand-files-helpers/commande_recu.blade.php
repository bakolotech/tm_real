<div class="table-header">
    <table cellpadding="0" cellspacing="0" border="0" style="z-index: 1">
        ...
        <div class="table-content-marchand field-none table-content-helper" id="detail-commande-marchant" style="background-color: #fff">

            <div class="line-product-clonned" onclick="closeDetailCommandePanel()">
                <div class="clonned-col1" id="clonned-col1" style="width: 110px;"></div>
                <div class="clonned-col2" id="clonned-col2" style="width: 277px;"></div>
                <div class="clonned-col3" id="clonned-col3" style="width: 278px;"></div>
                <div class="clonned-col4" id="clonned-col4" style="width: 72px;"></div>
                <div class="clonned-col5" id="clonned-col5" style="width: 112px;"></div>
                <div class="clonned-col6" id="clonned-col6" style="width: 77px;"></div>
                <div class="clonned-col7" id="clonned-col7" style="width: 182px;"></div>
                <div class="clonned-col8" id="clonned-col8" style="width: 101px;"></div>
            </div>


            <div class="detail-commande-prod-infos">
                <div class="marchand-commande-client-address" style="width: 190px; height: 100%; ; margin-right: 8px">
                ...
                <div class="marchand-commande-client-detail" style="width: 704px; ">
                    ...
                    <div class="detail-prod-body">
                        <table style="width: 704px; auto">
                            ...
                            <tbody id="marchand-commandes-details">

                            </tbody>

                            <div class="unkown_over_lay-div-2-detail field-none" id="overlay-detail-commande-marchand">
                                <article class="blockblur-detail-command" id="blockblur12">
                                    ...
                                    <input type="hidden" value="" name="commande_for_validation" id="commanade_ref_validation" />
                                    <input type="hidden" value="" name="commande_for_validation" id="commanade_ref_validation-id" />
                                    <input type="submit" class="btnnon" value="Non" onclick="closeCommandeValidation()">
                                    <input type="submit" class="btnoui" value="Oui" onclick="valideCommandeApresTraitement()">
                                    <aside>
                                 </article>
                            </div>
                ...
                <div class="marchand-commande-commande-infos" >
                    ...
                    <div class="commande-progress-state-zone">
                        ...
                        <aside class="commandeexped field-none" id="commande-encours-livraison-running" >
                            ...
                            <p class="commandeexpetext">En cours de livraison</p>
                        </aside>

                        <aside class="commanderecue field-none" id="commande-expedier-statut">
                            <div class="leftcommandeencours">
                                <img src="/assets/images/icones-vendeurs2/Valide.svg" style="margin-top:12px;margin-left:14px;">
                            </div>
                            <p class="commandeencourstext">Produit expédie</p>
                        </aside>
                        <aside class="commandeexped field-none" id="commande-expedier-statut-runing" >
                            <div class="leftcommandeexpe">
                                <lord-icon
                                src="https://cdn.lordicon.com/mwqnntww.json"
                                trigger="loop"
                            ...
                            <p class="commandeexpetext">Commande à expédier</p>
                        </aside>

                        <aside class="commanderecue field-none" id="commande-en-traitement-statut">
                            <div class="leftcommandeencours">
                                <img src="/assets/images/icones-vendeurs2/Valide.svg" style="margin-top:12px;margin-left:14px;">
                            </div>
                        ...
                        <aside class="commandelivr" id="commande-en-traitement-statut-running" >
        ...
        <div class="table-content-marchand">
            <div class="pas-de-commande-marchand field-none">Vous n'avez pas de commande pour l'instant</div>
            <table cellpadding="0" cellspacing="0" border="0" id="commande-table" >
                <tbody id="tab-marchand-commande" >
