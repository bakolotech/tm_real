...
@section('contenu')
    ...
    <div class="contenu-marchand">
        ...
        {{-- boutique produit container  --}}
        <div class="boutique-produit-container" style="position: absolute; width: 600px; height: auto; background: transparent; margin-left: 415px">
        ...
        <div class="bottom-bar-float">
            ...
            <div class="zone-user">
                ...
                <div class="icon-zone">
                    <img src="assets/images/oeil.svg" alt="" >
                </div>
                <div class="over-section">
