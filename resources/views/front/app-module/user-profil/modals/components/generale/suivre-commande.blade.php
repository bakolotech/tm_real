...
.input-recherche-echec-commande {
    box-sizing: border-box;
    height: 41px;
    width: 204px;
    border: 1px solid #9B9B9B;
    ...
    .step-section {
        ...
        border-left: 4px solid #1A7EF5;
        border-right: 4px solid #1A7EF5;
        background-color: #FFFFFF;
    }
    ...
    .steps .test-first-element:after {
	    content:"____________";
	    letter-spacing: 9px; /* Use letter-spacing to increase space between dots*/
        position: absolute;
        top: -8px;
    }

    .steps .test-first-element-active:after {
    ...
    .default-commande-btn {
        background-image: url('/assets/images/colis.svg') !important;
    ...
    .commande-actif-step {
        background-image: url('/assets/images/tm_fa_check.svg') !important;
        background-repeat: no-repeat !important;
        background-repeat: no-repeat !important;
        background-position: center !important;
        border: 2px solid #00B517 !important;
    }
    ...
    /* .current-commande-step::before {
        animation: pulse-ring 1.25s cubic-bezier(0.215, 0.61, 0.355, 1) infinite;
    }

    .current-commande-step::after {
    ...
    .steps .list-inline li.first  { position: relative; }
    .steps .list-inline li.middle  {
        /* left: 80px;  */
        position: relative;
        top: -12px;
    }
    .steps .list-inline li.last  {
        /* right: -181px;  */
        position: relative;
         top: -12px;
        }
    .steps .list-inline li.fouth  {
        /* right: -284px;  */
        position: relative;
        top: -12px;
    }

    .steps .list-inline li.fith {position: relative; right: 25px; top: -12px;}
    ...
    .date-suivis-elements {
        display: flex;
        flex-direction: column;
        row-gap: 27px;
    }

    .date-suivis-elements span {
        height: 13px;
        width: 109px;
        color: #191970;
        font-family: Roboto;
    ...
    .etapes-suivis-elements {
        display: flex;
        flex-direction: column;
        row-gap: 12px;
    }

    .etapes-suivis-element-1 {
        height: 25.5px;
        width: 639px;
        border-radius: 12.75px 6px 6px 12.75px;
        background-color: #F5F5F5;
        display: flex;
        align-items: center;
    }

    .etapes-suivis-element-1 img {
        /* margin-left: 10px; */
        position: absolute;
        width: 32px;
    }

    .etapes-suivis-element-1 span {
        height: 13px;
        width: 597px;
        color: #191970;
        font-family: Roboto;
    ...
    .active-commande-step {
        /* background-color: #191970 !important; */
        /* background-color: #1A7EF5 !important; */
    }

    .recherche_num_commande:hover{
        cursor: pointer;
    }
...
.current-commande-step::before {
  ...
  .current-commande-step::after {
    ...
    background-image: url('/assets/images/tm_start_white.svg') !important;
    background-repeat: no-repeat !important;
    background-repeat: no-repeat !important;
    background-position: center !important;
    border-radius: 250px;
    ...
    #client-lien-suivis-commande:hover {
        cursor: pointer;
        color: #7fb8fa;
    }
...
<div id="suivis-commandes" class="donnees-menu-profil" style="display: none">
    <div class="historique-commande-header" style="padding-top: 10px; ">
    <span class="historique-commande-head">Suivre une commande</span></div>
    <div class="maGdiv">

        <div class="tookan-map-displayer field-none" id="suivre-commande-tracking-link">
            <iframe id="client-tracking-link" style="width: 100%" height="100%" src=""></iframe>
        </div>

      <div class="table-content" style="height: 456px; width: 858px">
        <div class="main-elements-historique" >
            <!-- input section  -->
            <div class="input-commande-section">

              <div class="numero-de-suivi">
                  <label class="num-commande-echec">Renseignez le n° de suivi de 11 à 15 caractères</label>

                  <div class="input-group">
                      <div class="input-group">
                          <input type="text" style="padding-left: 10px" class="form-controljj input-recherche-echec-commande" placeholder="Ex: 6A22158634852" aria-label="Recipient's username" aria-describedby="basic-addon2">
                          <div class="input-group-append recherche_num_commande">
                            <span class="input-group-text bouton-recherche" style="height: 41px !important">Recherche</span>
                          </div>
                        </div>
                  </div>
              </div>
              ...
              <div class="regions">
                  <label class="num-commande-echec">Régions</label>
                  <div class='parent-0 select-main-div my-form-field pl-0  ' style="background-color:#D8D8D8; width: 253px"data-ul-id='#form-profil-ville' >
                    <div class='select-main-div-img' style="border-right: 1px solid #9B9B9B; width:197px; height: 41px;
                    width: 41px;
                    "><img src='{{ $monPays->getImage() }}' alt='' ></div>
                    <div class='select-main-div-text'>@auth{{ $_SESSION['config']['user-ville']['name'] }}@endauth</div>
                </div>
          ...
          <div id="client_current_commande" class="field-none">
            <div class="step-section custom-step-section" style="display: flex; flex-direction:column; justify-content: flex-start; align-items: center;">

            <div class="numero-suivi-value" style="margin-bottom: 10px; margin-top: 45.36px; position: relative; top: -25px; width: 270px">
                <span class="num-produit-commande">N° de suivi:</span> <span class="num-produit-commande-value" id="client-lien-suivis-commande">XXXXXXXXXXXXX</span>
            </div>

            <div class="steps">
                {{-- <div class="progress-line"> --}}
                    <ul class="list-inline" style="width: 800px !important; left: 22px; position: relative">

                    <li class="first test-first-element" id="li-step-1" style="top: -12px; width: 180.5px !important;">

                        <div class="circle commande-custom-circle default-commande-btn" id="client-commande-step-1" ><div class="circled inner-circlek">
                    </div></div>

                        <div class="step-id field-nonet" style="width: 61px; height: 39px; " id="commande-text-step-1">En cours de
                        vérification.
                        <span id="commande-date-verification" style="color: red !important"></span>
                    </div>
                    </li>

                    <li class="middle test-first-element" id="li-step-2" style="width: 197.5px !important; ">
                        <div class="circle commande-custom-circle default-commande-btn" id="client-commande-step-2" style=""><div class="circlel inner-circlem">
                        </div></div>
                        <div class="step-id field-none" id="commande-text-step-2" style="width: 92px; height: 26px; left: -44px" >Il est en traitement
                        dans notre réseau.</div>
                    </li>

                    <li class="last test-first-element" id="li-step-3" style="width: 198px !important; ">
                        <div class="circle commande-custom-circle default-commande-btn" id="client-commande-step-3"><div class="circles inner-circles">
                        </div></div>

                        <div class="step-id field-none" id="commande-text-step-3" style="width: 120px; height: 26px; left: -53px" >Votre colis est arrivé
                        sur son site de livraison.</div>
                    </li>

                    <li class="fouth test-first-element" id="li-step-4" style="width: 180.5px !important; ">
                        <div class="circle commande-custom-circle default-commande-btn" id="client-commande-step-4"><div class="circles inner-circles">
                        </div></div>

                        <div class="step-id field-none" id="commande-text-step-4" style=" width: 110px; height: 26px; left: -51px">Nous préparons votre
                        colis pour sa livraison.</div>
                    </li>

                    <li class="fith " id="li-step-5">
                        <div class="circle commande-custom-circle default-commande-btn" id="client-commande-step-5" style="left: 11px"><div class="circles inner-circles">
                        </div></div>
                        <div class="step-id field-none" id="commande-text-step-5" style="width: 59px; height: 39px; left: -6px">Votre colis
                        a été livré.
                        <span style="color: #D0021B" id="heure-livraison-client">30/12/2021</span>
                        </div>
                    </li>
            ...
            <div class="last-data-table">
                <div class="date-suivi">
                    <h4>HEURES</h4>
                    <div class="date-suivis-elements">
                        <span id="date-step-4" class="field-none" >Vendredi 29 octobre</span>
                        <span id="date-step-3" class="field-none" >Vendredi 29 octobre</span>
                        <span id="date-step-2" class="field-none" >Vendredi 29 octobre</span>
                        <span id="date-step-1" class="field-none" >Vendredi 29 octobre</span>
                    </div>
                </div>
                <div class="etapes-suivi">
                    <h4>ÉTAPES</h4>
                    <div class="etapes-suivis-elements">
                       <div class="etapes-suivis-element-1 field-none" id="commande-step-text-4">
                           <img src="/assets/images/icons/Valide.svg" alt=""> <span>Votre colis est livré.</span>
                       </div>
                       <div class="etapes-suivis-element-1 field-none" id="commande-step-text-3">
                            <img src="/assets/images/icons/Valide.svg" alt=""> <span>Votre colis est dans le site de livraison qui dessert votre adresse. Nous le préparons pour le mettre en livraison.</span>
                        </div>
                        <div class="etapes-suivis-element-1 field-none" id="commande-step-text-2">
                            <img src="/assets/images/icons/Valide.svg" alt=""> <span>Votre colis est en transit sur nos plateformes logistiques pour vous être livré le plus rapidement possible.</span>
                        </div>
                        <div class="etapes-suivis-element-1 field-none" id="commande-step-text-1">
                            <img src="/assets/images/icons/Valide.svg" alt=""> <span>Votre colis va bientôt nous être confié ! Il est en cours de préparation chez votre expéditeur.</span>
                        </div>
                    </div>
                </div>
            </div>
