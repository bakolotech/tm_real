                    ...
                    {{-- <div class="row"> --}}
                        ...
                        <div class="col-lg-12 col-md-12 div-2h" >
                            <div class="informations-commerce">
                                   ...
                                   <div class="carte-boutique-detail" style="padding-top: 15px;">
                                    <div class="boutique-checkbox" style="margin-left: 15px;">
                                        ...
                                        <div class="checkbox-content" style="display: flex; column-gap: 30px">
                                            <div>
                                            <input @if((isset($_SESSION['boutique_organisation_suppInfos']['nom_boutique'])) && $_SESSION['boutique_organisation_suppInfos']['type_boutique'] == "Détaillant")
                                                checked
                                            ...
                                            <div>
                                            <input @if((isset($_SESSION['boutique_organisation_suppInfos']['nom_boutique'])) && $_SESSION['boutique_organisation_suppInfos']['type_boutique'] == "Grossiste")
                                            checked
                                    ...
                                    <div style="" class="nom-boutique-section">
                                        <button class="spiner-box-zone">
                                            ...
                                            <input class="input-rectangle-long-boutique" style="padding-left: 15px" type="text" placeholder="Nom de la boutique" value="@if(isset($_SESSION['boutique_organisation_suppInfos']['nom_boutique'])) {{$_SESSION['boutique_organisation_suppInfos']['nom_boutique']}} @endif" id="nom-boutique"/>
                                ...
                                <p style="" class="boutique-header-text">
            ...
            <div class="bottom-divd" style="display: flex; margin-top: 15px; background-color: #fff; padding: 0px 80px 0px 80px">
                <div class="group-3">
                    <button type="submit" class="group3 bouton-annuler" style="margin-right: 10px" onclick="retour(event)" id="boutiqueCancel">
                        <a style="text-decoration: none" href="/marchand-facturation-organisation">Retour</a>
                    </button>
