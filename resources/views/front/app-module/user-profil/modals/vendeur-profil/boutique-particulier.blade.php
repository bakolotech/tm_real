                            ...
                            <div class="informations-commerce">
                                   ...
                                   <div class="carte-boutique-detail" style="padding-top: 15px;">
                                    <div class="boutique-checkbox" style="margin-left: 15px;">
                                        ...
                                        <div class="checkbox-content" style="display: flex; column-gap: 30px">
                                            <div>
                                            <input class="radio-check-icon one-check-1 checkbox-size" id="type-boutik-1" name="type_boutique" type="checkbox" value="Détaillant">
                                                <span class="btik-type">Détaillant</span></div>
                                            <div>
                                            <input class="radio-check-icon one-check-1 checkbox-size" id="type-boutik-2"  name="type_boutique" type="checkbox" value="Grossite">
                                    ...
                                    <div style="" class="nom-boutique-section">
                                        ...
                                        <input class="input-rectangle-long-boutique" style="padding-left: 15px" type="text" value="@if(isset($_SESSION['boutique_particulier']['nom_boutique'])) {{$_SESSION['boutique_particulier']['nom_boutique']}} @endif" placeholder="Nom de la boutique" id="nom-boutique"/>
                                ...
                                <div class="d-flex" style="height: 20px; width: 351px; margin-top: 5px;">
                                    <div class="checkbox-content" style="display: flex; column-gap: 30px">
                                        ...
                                        <input class="radio-check-icon one-check-2 checkbox-size" id="question-boutik-1" name="question_1d" type="checkbox" value="oui">
                                            <span class="btik-type1">Oui</span></div>

                                        <div style="display: flex" class="question-proprietaire-element">
                                        <input  class="radio-check-icon one-check-2 checkbox-size" id="question-boutik-2"  name="question_1D" type="checkbox" value="non">
                                        <span class="btik-type1">Non</span></div>

                                        <div style="display: flex" class="question-proprietaire-element">
                                            <input class="radio-check-icon one-check-2 checkbox-size" id="question-boutik-3"  name="question_1D" type="checkbox" value="certain">
                                    ...
                                    <p class="boutik-questions-2" >
                                        ...
                                        <div class="d-flex" style="height: 20px; width: 251px; margin-top: 5px; ">
                                            <div class="d-flex radio-group">
                                                <input class="radio-check-icon one-check-3 checkbox-size" name="question_2" type="checkbox" value="Oui">
                                                <div class="radio-text btik-type1">Oui</div>
                                            </div>
                                            <div class="d-flex radio-group" style="margin-left: 15px;">
                                                <input class="radio-check-icon one-check-3 checkbox-size" name="question_2" type="checkbox" value="Non">
                                                <div class="radio-text btik-type1">Non</div>
                                            </div>
                                            <div class="d-flex radio-group" style="margin-left: 15px;">
                                                <input class="radio-check-icon one-check-3 checkbox-size" name="question_2" type="checkbox" value="Certains">
                                                <div class="radio-text btik-type1">Certain(e)s</div>
                                            </div>
                                        </div>
            ...
            <div class="bottom-divd" style="display: flex; margin-top: 15px; background-color: #fff; padding: 0px 80px 0px 80px">
                <div class="group-3">
                    <button type="submit" class="group3 bouton-annuler" style="margin-right: 10px" onclick="retour(event)" id="boutiqueCancel">
                        <a style="text-decoration: none" href="/marchand-facturation-particulier">Retour</a>
                    </button>
...
function checkboxStatusChange(id) {
    console.log('nous sommes bien dedans')
...
// ----------------------------------------------------------------------------
    ...
    function saveMarchandInformationPerso(e) {
        ...
        if (nombre_rayon === 0 && univer_section > 0) {
            console.log('rien de bon dans ce couloir')
        ...
        setTimeout(() => {
            if ( !$("#nom-boutique").hasClass('input-error-warning-long') && !$('#univers_div_select').hasClass('border-error-univ') && !$('.slider-head').hasClass('border-error-univ') && type_boutique != null) {
                ...
                success:function(response){
                    console.log('les choses de la', response)
