...
<div class="rectangle">
    <div class="containerD mask" style="display: flex; flew-direction: column">
      ...
      <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                        ...
                        <div class="panel-button-text">Informations sur le vendeur</div>
                    </div>
                                       ...
                                       <div class="carte-credit-detail normal-box-bordedr paiement-box-disabled" id="section-carte-credit" style="padding-top: 15px;">
                                        ...
                                        <div class="main-box-facture">
                                            <div class="box-input1" >
                                                ...
                                                <input type="text" style="padding-left: 10px" class="rectangle-input" id="numero-carte" value="@if(isset($_SESSION['facturation_organisation']['numero_carte']) && !is_array($_SESSION['facturation_organisation']['numero_carte'])) {{$_SESSION['facturation_organisation']['numero_carte']}} @endif" placeholder="XXXXXXXXXXXX">
                                            </div>
                                            <div class="box-input1" style="margin-left: 10px">
                                                <div class="label-el">Date d'expiration</div>
                                                <input value="@if(isset($_SESSION['facturation_organisation']['date_expiration'])){{$_SESSION['facturation_organisation']['date_expiration']}}
                                            ...
                                            <div class="box-input1" style="margin-left: 10px">
                                                ...
                                                <input value="@if(isset($_SESSION['facturation_organisation']['code_cvv']))
                                                {{$_SESSION['facturation_organisation']['code_cvv']}} @endif" type="text" style="padding-left: 10px" class="rectangle-input" id="code-cvv" placeholder="" style="font-size: 12px;padding-left:5px;">
                                        ...
                                        <div style=" height: 60px; width: 603px; position: relative; margin-left: auto; margin-right: auto;">
                                            ...
                                            <input value="@if(isset($_SESSION['facturation_organisation']['nom_sur_carte'])){{$_SESSION['facturation_organisation']['nom_sur_carte']}} @endif"  type="text" style="padding-left: 10px; width: 603px" class="rectangle-input" id="nom-complet-sur-carte" placeholder="Moussavou Ulrich" onkeyup="letterOnlyMonCarte(this)">

                                            <div style="width: 100%; height: 13px; margin-top: 5px; display: flex">

                                                <div style="width: 18px; height: 18px">
                                                    <input type="checkbox" class="checkbox-confirmation" style="" />
                                                </div>
                                   ...
                                   <div class="carte-credit-detail normal-box-border paiement-box-disabled" id="serviceMobileSection" style="padding-top: 15px;">
                                    ...
                                    <div style=" height: 60px; width: 603px;position: relative; margin-left: auto; margin-right: auto; display: flex; margin-bottom: 15px;">
                                        <div class="box-input1" style="width: 294px;">
                                            ...
                                            <input value="@if(isset($_SESSION['facturation_organisation']['numero_carte']) && is_array($_SESSION['facturation_organisation']['numero_carte'])) {{$_SESSION['facturation_organisation']['numero_carte'][0][0]}} @endif" type="text" style="padding-left: 10px; width: 294px;" class="rectangle-input" id="airtel_num" placeholder="Moussavou Ulrich" onkeyup="letterOnlyFacture(this)">
                                        </div>

                                        <div class="box-input1" style="margin-left: 15px; width: 294px;">
                                            <div class="label-el">Code marchand</div>
                                            <input value="@if(isset($_SESSION['facturation_organisation']['numero_carte'][0][1]))
                                            {{$_SESSION['facturation_organisation']['numero_carte'][0][1]}}
                                    ...
                                    <div style=" height: 60px; width: 603px;position: relative; margin-left: auto; margin-right: auto; display: flex; margin-bottom: 15px">
                                        <div class="box-input1" style="width: 294px;">
                                            ...
                                            <input value="@if(isset($_SESSION['facturation_organisation']['numero_carte']) && is_array($_SESSION['facturation_organisation']['numero_carte'])) {{$_SESSION['facturation_organisation']['numero_carte'][1][0]}} @endif" type="text" style="padding-left: 10px; width: 294px;" class="rectangle-input" id="moov_num" placeholder="Moussavou Ulrich" onkeyup="letterOnlyFacture1(this)">
                                        ...
                                        <div class="box-input1" style="margin-left: 15px; width: 294px;">
                                            <div class="label-el">Code marchand</div>
                                            <input value="@if(isset($_SESSION['facturation_organisation']['numero_carte'][1][1])) {{$_SESSION['facturation_organisation']['numero_carte'][1][1]}} @endif" type="text" style="padding-left: 10px; width: 294px;" class="rectangle-input" id="code_marchand_moov" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                </div>
                ...
                <div class="group-3">
                    <button type="submit" class="group3 bouton-annuler" style="margin-right: 10px" onclick="retour(event)" id="cancelInfosEntreprise">
                        <span class="mbtn-text">
                            <a style="text-decoration: none" href="/marchand-informations-organisation">Retour</a>
                        </span>
                    </button>
            ...
            if ($("#mobile-payement-default").is(':checked')) {
                ...
                console.log('votre tableau mobile:', facturation_mobile, 'et le tableau carte visa:', facturation)
                    ...
                    success:function(response){
                        ...
                        window.location.href = "/marchand-boutique-organisation"
                     }
                    });
                }
