                ...
                <form  data-btn="#login-register-btn">
                        ...
                        <div>
                            ...
                            <div class="informations-commerce">
                                <div class="d-flex justify-content-center text-infos">Informations commerciales pour @if(isset($_SESSION['nomEntrepriseCaritative'])) {{$_SESSION['nomEntrepriseCaritative']}} @endif </div>
                            </div>
                                ...
                                <div class="label-el">Numéro d'immatriculation de la société
                                    <small class="tooltips">
                                        ...
                                        <span class="tooltiptext"><p >
                                            Indiquez le code de crédit social unifié trouvé sur votre licence commerciale. Une licence d’exploitation est une autorisation délivrée par les agences gouvernementales qui permet à des individus ou entreprises de faire des affaires.
                                        </p></span>
                                    </small>
                                </div>
                                <input type="text" style="padding-left: 10px; width: 633px" class="rectangle-input" id="matriculeEntreprise" value="@if(isset($_SESSION['boutique_organisation']['matriculeEntreprise'])){{$_SESSION['boutique_organisation']['matriculeEntreprise']}} @endif" placeholder="XXXX">
                            </div>
                             ...
                             <div class="container-2-infos-add" style="margin-top: 20px">Adresse de l’entreprise
                                ...
                                <div class="container-2-infos">
                                    <div class="line-container-2" style="display: flex; margin-top: 15px">
                                        ...
                                        <div class="box-input1" style="margin-left: 10px;">
                                            <input type="text" style="padding-left: 10px" value="@if(isset($_SESSION['boutique_organisation']['provinceEntreprise'])){{$_SESSION['boutique_organisation']['provinceEntreprise']}} @endif" class="rectangle-input" id="provinceEntreprise" placeholder="Province">
                                        </div>

                                        <div class="box-input1" style="margin-left: 10px">
                                            <input type="text" style="padding-left: 10px" value="@if(isset($_SESSION['boutique_organisation']['villeEntreprise'])) {{$_SESSION['boutique_organisation']['villeEntreprise']}} @endif" class="rectangle-input" id="villeEntreprise" placeholder="Ville">
                                        </div>
                                    ...
                                    <div class="line-container-2" style="display: flex; margin-top: 5px">
                                        <div class="box-input1" style="margin-left: 15px">
                                            <input type="text" style="padding-left: 10px" value="@if(isset($_SESSION['boutique_organisation']['adresseEntreprise'])) {{$_SESSION['boutique_organisation']['adresseEntreprise']}} @endif" class="rectangle-input" id="adresseEntreprise" placeholder="Adresse">
                                        </div>

                                        <div class="box-input1" style="margin-left: 10px">
                                            <input style="padding-left: 15px" type="text" class="rectangle-input" value="@if(isset($_SESSION['boutique_organisation']['codePostalEntreprise'])) {{$_SESSION['boutique_organisation']['codePostalEntreprise']}} @endif"  id="codePostalEntreprise" placeholder="Code postal">
                                        </div>

                                        <div class="box-input1" style="margin-left: 10px">
                                            <input type="text" style="padding-left: 10px" class="rectangle-input" value="@if(isset($_SESSION['boutique_organisation']['compAdresseEntreprise'])) {{$_SESSION['boutique_organisation']['compAdresseEntreprise']}} @endif"  id="codePostalEntreprise" id="compAdresseEntreprise" placeholder="Comp. d’adresse (facultatif)" style="font-size: 12px;padding-left:5px;">
                                        </div>
                                ...
                                <div class="form-fields" style="margin-top: 15px; margin-left: 43px">
                                    <div class="col-8">
                                            ...
                                            @if(isset($_SESSION['boutique_organisation']['numeroEntreprise']))
                                            ...
                                            @endif
                                                ...
                                                <div class="" style="width: 40%; height: 100%; position: relative; left: 61.5px;">
                                                    <input style="padding-left: 19px; border-radius: 0px 6px 6px 0px; position: relative; left: -72px" type="text" class="input-neutre" value="@if(isset($_SESSION['boutique_organisation']['numeroEntreprise']))
                                                        {{$_SESSION['boutique_organisation']['numeroEntreprise']}}
                                                ...
                                                <div id="tm-zone-code1" class="tm-zone-code input-none" style="position: absolute; margin-left: 450px; width: 100px; height: 37px; display: flex">
                                                    ...
                                                    <input style="width: 70px; height: 37px; border: 1px solid #979797; border-left: none"  type="text" value=""  class=" input-code">
                                                </div>
                                ...
                                <div style="margin-left: 15px; margin-top: 15px">
                                    <div class="rowx" style="display: flex">
                                        <div class="col-md-4j" style="margin-right: 10px">
                                            <input type="text" class="adress-principal-input" name="prenomContactEntreprise" id="prenomContactEntreprise" value="@if(isset($_SESSION['boutique_organisation']['prenom2ContactEntreprise'])){{$_SESSION['boutique_organisation']['prenom2ContactEntreprise']}} @endif" placeholder="Prénom" onkeyup="letterOnlyEntreprise(this)">
                                        </div>

                                        <div class="col-md-4k" style="margin-right: 10px">
                                            <input type="text" class="adress-principal-input" name="prenom2ContactEntreprise" id="prenom2ContactEntreprise" value="@if(isset($_SESSION['boutique_organisation']['prenom2ContactEntreprise'])) {{$_SESSION['boutique_organisation']['prenom2ContactEntreprise']}} @endif" placeholder="Second prénom" onkeyup="letterOnly2Entreprise(this)">
                                        </div>
                                        <div class="col-md-4l" >
                                            <input type="text" class="adress-principal-input" name="nomfamilleContactEntreprise" value="@if(isset($_SESSION['boutique_organisation']['nomFamilleContactEntreprise'])){{$_SESSION['boutique_organisation']['nomFamilleContactEntreprise']}} @endif" id="nomFamContactEnt" placeholder="Nom de famille" onkeyup="letterOnly2EntrepriseNomFamille(this)">
                                        </div>
                                    </div>
...
<script>
    ...
    function saveMarchandRenseignementPrivee(event) {
            ...
            success:function(response){
                ...
                window.location.href = "/marchand-informations-organisation"
            }
            });
        }
