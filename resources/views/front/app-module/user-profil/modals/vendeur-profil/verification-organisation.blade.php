                        ...
                        <div class="col-lg-12 col-md-12 div-2h" >
                            <div class="informations-commerce">
                                ...
                                <div class="box-1-facturation" style="margin-top: 30px;">
                                    ...
                                    <div class="label-el" style="margin-left: 42px; margin-top:10px" >Récapitulatif des informations du vendeur</div>
                                   <div class="verification-boutique-detail" style="padding-top: 15px;">
                                   ...
                                   <div style=" height: 60px; width: 603px;position: relative; margin-left: auto; margin-right: auto; display: flex; margin-bottom: 15px">
                                        <div class="box-input1" style=" width: 294px;">
                                            ...
                                            <input type="text" style="padding-left: 10px" class="input-verification" value="{{$_SESSION['boutique_organisation']['prenomContactEntreprise']}} {{$_SESSION['boutique_organisation']['nomFamilleContactEntreprise']}}" id="ville-particulier" placeholder="Ville">
                                        </div>

                                        <div class="box-input1" style="margin-left: 15px; width: 294px;">
                                            <div class="label-el">Date de naissance</div>
                                            <input type="text" style="padding-left: 10px" class="input-verification" value="{{$_SESSION['infos_organisation']['dateNaissPrivee']}}" id="adresse-particulier" placeholder="Adresse">
                                        </div>
                                    </div>
                                    ...
                                    <div style=" height: 60px; width: 603px;position: relative; margin-left: auto; margin-right: auto; display: flex; margin-bottom: 15px">
                                        <div class="box-input1" style="width: 294px;">
                                            ...
                                            <input type="text" style="padding-left: 10px" class="input-verification" value="{{$_SESSION['infos_organisation']['paysNaissancePrivee']}}" id="ville-particulier" placeholder="Ville">
                                        </div>

                                        <div class="box-input1" style="margin-left: 15px; width: 294px;">
                                            <div class="label-el">Pays de citoyenneté</div>
                                            <input type="text" style="padding-left: 10px" class="input-verification" value="{{$_SESSION['infos_organisation']['paysCitoyenPrivee']}}" id="adresse-particulier" placeholder="Adresse">
                                        </div>
                                    </div>
                                    <div style=" height: 60px; width: 603px;position: relative; margin-left: auto; margin-right: auto; display: flex; margin-bottom: 15px">
                                        <div class="box-input1" style=" width: 294px;">
                                            <div class="label-el">Données d’identité</div>
                                            <input type="text" style="padding-left: 10px" class="input-verification" value="@if(isset($_SESSION['infos_organisation']['typePieceIdentitePrivee']) && $_SESSION['infos_organisation']['typePieceIdentitePrivee'] =="Carte national d'identité") #CNI: {{$_SESSION['infos_organisation']['numeroPiecePrivee']}} / Exp: {{$_SESSION['infos_organisation']['dateExpiration']}} @else {{$_SESSION['infos_organisation']['typePieceIdentitePrivee']}}: {{$_SESSION['infos_organisation']['numeroPiecePrivee']}} / Exp: {{$_SESSION['infos_organisation']['dateExpiration']}}  @endif" id="ville-particulier" placeholder="Ville">
                                        </div>
                                    ...
                                    <div style="position: relative; top: 30px">
                                        <div class="label-el"  >Récapitulatif des informations de la boutique</div>
                                        <div class="verification-boutique-detail" style="height: 170px; padding-top: 15px; position: relative;">
                                            <div style=" height: 60px; width: 603px;position: relative; margin-left: auto; margin-right: auto; display: flex; margin-bottom: 15px">

                                                <div class="box-input1" style="width: 294px;">
                                                    <div class="label-el">Nom commercial</div>
                                                    <input type="text" style="padding-left: 10px" value="{{$_SESSION['nomEntrepriseCaritative']}}" class="input-verification" id="ville-particulier" placeholder="Ville">
                                                </div>

                                                <div class="box-input1" style="margin-left: 15px; width: 294px;">
                                                    <div class="label-el">N° d'immatriculation de la société</div>
                                                    <input type="text" style="padding-left: 10px" value="{{$_SESSION['boutique_organisation']['matriculeEntreprise']}}" class="input-verification" id="matricule_entreprise" placeholder="Adresse">
                                                </div>
                                            </div>

                                            <div style=" height: 60px; width: 603px;position: relative; margin-left: auto; margin-right: auto; display: flex; margin-top: 15px">

                                                <div class="box-input1" style="width: 294px;">
                                                    <div class="label-el">Adresse de 'entreprise</div>
                                                    <input type="text" style="padding-left: 10px" value="@if(isset($_SESSION['boutique_organisation']['adresseEntreprise'])) GA, {{$_SESSION['boutique_organisation']['provinceEntreprise']}}, {{$_SESSION['boutique_organisation']['villeEntreprise']}}, {{$_SESSION['boutique_organisation']['codePostalEntreprise']}}, {{$_SESSION['boutique_organisation']['adresseEntreprise']}}  @endif" class="input-verification" id="ville-particulier" placeholder="Ville">
                                                </div>

                                                <div class="box-input1" style="margin-left: 15px; width: 294px;">
                                                    <div class="label-el"><small style="font-size: 16px; color: red; position: relative; top: 3px">*</small>Fiche circuit/Patente</div>
                                                    <div class="d-flex rectangle-input-2-1" style="width: 294px;">

                                                        <div class="middle-element-doc" style="">
                                                            <label id="pieceRelevePreview" style="font-size: 14px; position: relative;top: 9px; width: 241px !important; padding-left:5px;"> </label>
                                                        </div>

                                                        <div style="position: relative; top: 3.5px; left: -5px">
                                                            <article style="" class="pass-main" style="">
            ...
            <div class="bottom-divd" style="display: flex; margin-top: 15px; background-color: #fff; padding: 0px 80px 0px 80px">
                <div class="group-3">
                    ...
                    <button type="submit" class="group3 bouton-annuler1" style="" onclick="retour(event)" id="soumettreCancelBtn">
                        <span class="mbtn-text"><a style="text-decoration: none" href="/marchand-boutique-organisation">Retour</a></span>
                    </button>
                        ...
                        <span class="spinner-borderSD" id="sms_spiner-resend"role="status" aria-hidden="true"></span>
                    </button>
                </div>
            </div>
        </div>
...
<script>
    ...
    function saveMarchandVerificationParticulier(e) {
        ...
        formData.append('type_activite', 2);
