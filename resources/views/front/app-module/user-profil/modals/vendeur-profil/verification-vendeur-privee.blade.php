                                ...
                                <div class="box-1-facturation" style="margin-top: 30px;">
                                   ...
                                   <div  style=" height: 60px; width: 603px;position: relative; margin-left: auto; margin-right: auto; display: flex; margin-bottom: 15px; ">
                                        <div class="box-input1" style=" width: 294px;">
                                            ...
                                            <input type="text" style="padding-left: 10px" class="input-verification" value="{{$_SESSION['boutique_privee']['prenomContactEntreprise']}} {{strtoupper($_SESSION['boutique_privee']['nomFamilleContactEntreprise'])}}" id="ville-particulier" placeholder="Ville">
                                        </div>

                                        <div class="box-input1" style="margin-left: 15px; width: 294px;">
                                            <div class="label-el">Date de naissance</div>
                                            <input type="text" style="padding-left: 10px" class="input-verification" value="{{$_SESSION['infos_privee']['dateNaissPrivee']}}" id="adresse-particulier" placeholder="Adresse">
                                        </div>
                                    </div>
                                    ...
                                    <div style=" height: 60px; width: 603px;position: relative; margin-left: auto; margin-right: auto; display: flex; margin-bottom: 15px">
                                        ...
                                        <div class="box-input1" style="width: 294px;">
                                            ...
                                            <input type="text" style="padding-left: 10px" class="input-verification" value="{{$_SESSION['infos_privee']['paysNaissancePrivee']}}" id="ville-particulier" placeholder="Ville">
                                        </div>

                                        <div class="box-input1" style="margin-left: 15px; width: 294px;">
                                            <div class="label-el">Pays de citoyenneté</div>
                                            <input type="text" style="padding-left: 10px" class="input-verification" value="{{$_SESSION['infos_privee']['paysCitoyenPrivee']}}" id="adresse-particulier" placeholder="Adresse">
                                        </div>
                                    </div>
                                    <div style=" height: 60px; width: 603px;position: relative; margin-left: auto; margin-right: auto; display: flex; margin-bottom: 15px">
                                        ...
                                        <div class="box-input1" style=" width: 294px;">
                                            ...
                                            <input type="text" style="padding-left: 10px" class="input-verification" value="@if(isset($_SESSION['infos_privee']['typePieceIdentitePrivee']) && $_SESSION['infos_privee']['typePieceIdentitePrivee'] =="Carte national d'identité") #CNI: {{$_SESSION['infos_privee']['numeroPiecePrivee']}} / Exp: {{$_SESSION['infos_privee']['dateExpiration']}} @else {{$_SESSION['infos_privee']['typePieceIdentitePrivee']}}: {{$_SESSION['infos_privee']['numeroPiecePrivee']}} / Exp: {{$_SESSION['infos_privee']['dateExpiration']}}  @endif" id="ville-particulier" placeholder="Ville">
                                        </div>
                                  ...
                                  <div style="position: relative; top: 30px">
                                    ...
                                    <div style=" height: 60px; width: 603px;position: relative; margin-left: auto; margin-right: auto; display: flex; margin-bottom: 15px">
                                        ...
                                        <div class="box-input1" style="width: 294px;">
                                            ...
                                            <input type="text" style="padding-left: 10px" value="{{$_SESSION['infos_marchand_privee']['nomEntreprise']}}" class="input-verification" id="ville-particulier" placeholder="Ville">
                                        </div>

                                        <div class="box-input1" style="margin-left: 15px; width: 294px;">
                                            <div class="label-el">N° d'immatriculation de la société</div>
                                            <input type="text" style="padding-left: 10px" value="093930034AK903" class="input-verification" id="matricule_entreprise" placeholder="Adresse">
                                        </div>
                                    ...
                                    <div style=" height: 60px; width: 603px;position: relative; margin-left: auto; margin-right: auto; display: flex; margin-top: 15px">
                                        <div class="box-input1" style="width: 294px;">
                                            ...
                                            <input type="text" style="padding-left: 10px" value="@if(isset($_SESSION['boutique_privee']['adresseEntreprise'])) GA, {{$_SESSION['boutique_privee']['provinceEntreprise']}}, {{$_SESSION['boutique_privee']['villeEntreprise']}}, {{$_SESSION['boutique_privee']['codePostalEntreprise']}}, {{$_SESSION['boutique_privee']['adresseEntreprise']}}  @endif" class="input-verification" id="ville-particulier" placeholder="Ville">
                                        </div>
                                        ...
                                        <div class="box-input1" style="margin-left: 15px; width: 294px;">
                                            ...
                                            <div style="position: relative; top: 3.5px">
                                                <article style="margin-right: 5px" class="pass-main">
            ...
            <div class="bottom-divd" style="display: flex; margin-top: 15px; background-color: #fff; padding: 0px 80px 0px 80px">
                <div class="group-3">
                    <button type="submit" class="group3 bouton-annuler1" style="" onclick="retour(event)" id="soumettreCancelBtn">
                        <span class="mbtn-text"><a style="text-decoration: none" href="/marchand-boutique-vendeur-privee">Retour</a></span>
                    </button>
                        ...
                        <span class="spinner-borderDS" id="sms_spiner-resend"role="status" aria-hidden="true"></span>
                    </button>
                </div>
            </div>
        </div>
...
<script>
    ...
    function saveMarchandVerificationParticulier(e) {
        ...
        formData.append('type_activite', 3);
